export default {
  ...
  githubName: "mikuwife",                                     // 必须修改，github账户名
  ...
  title: "岁寒松柏",                                        // 网站标题
  nickName: "mikucat",                                           // 昵称
  domain: "https://mikucat.cn",                        // rss域名
  SEO_title: " - 岁寒松柏",                              // 搜索引擎显示的标题
  SEO_description: "mikucat的博客，书写值得书写的东西",               // description meta header
  SEO_keywords: "mikucat,mikucat's blog,岁寒松柏,岁寒松柏的博客", // keywords meta header
